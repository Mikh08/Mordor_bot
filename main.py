...
def start(message):
    ...
    bot.send_photo(message.chat.id,
                   'https://sun9-41.userapi.com/impg/-9r6EWoYbiFjtspC7ScXaZRrH_y6dCfT4WzI4w/ZUPH9Zdki8A.jpg?size=1080x1080&quality=95&sign=d26dbc797f3548796dc2f06c161144e8&type=album', messages.start_message, reply_markup=markup, parse_mode='html')
...
def callback_check(callback):
    if callback.data == "delux":  # Сообщение при выборе Deluxe
        ...
        bot.delete_message(chat_id=callback.message.chat.id,
                           message_id=callback.message.id)  # Удаление пердыдущего сообщения
        bot.send_message(chat_id=callback.message.chat.id, text=messages.answer_delux,
        ...
        bot.delete_message(chat_id=callback.message.chat.id,
                           message_id=callback.message.id)  # Удаление пердыдущего сообщения
        bot.send_message(chat_id=callback.message.chat.id, text=messages.answer_extra,
                         reply_markup=markup, parse_mode='html')  # Текст сообщения
        ...
        bot.delete_message(chat_id=callback.message.chat.id,
                           message_id=callback.message.id)  # Удаление пердыдущего сообщения
        bot.send_message(chat_id=callback.message.chat.id, text=messages.answer_essen,
                         reply_markup=markup, parse_mode='html')  # Текст сообщения
        ...
        bot.delete_message(chat_id=callback.message.chat.id,
                           message_id=callback.message.id)  # Удаление пердыдущего сообщения
        bot.send_message(chat_id=callback.message.chat.id, text=messages.answer_eplay,
                         reply_markup=markup, parse_mode='html')  # Текст сообщения
        ...
        bot.delete_message(chat_id=callback.message.chat.id,
                           message_id=callback.message.id)  # Удаление пердыдущего сообщения
        bot.send_message(chat_id=callback.message.chat.id, text=messages.time_delux_1_month,
                         reply_markup=markup, parse_mode='html')  # Текст сообщения
        ...
        bot.delete_message(chat_id=callback.message.chat.id,
                           message_id=callback.message.id)  # Удаление пердыдущего сообщения
        bot.send_message(chat_id=callback.message.chat.id, text=messages.time_delux_12_month,
                         reply_markup=markup, parse_mode='html')  # Текст сообщения
        ...
        bot.delete_message(chat_id=callback.message.chat.id,
                           message_id=callback.message.id)  # Удаление пердыдущего сообщения
        bot.send_message(chat_id=callback.message.chat.id, text=messages.time_extra_1_month,
                         reply_markup=markup, parse_mode='html')  # Текст сообщения
        ...
        bot.delete_message(chat_id=callback.message.chat.id,
                           message_id=callback.message.id)  # Удаление пердыдущего сообщения
        bot.send_message(chat_id=callback.message.chat.id, text=messages.time_extra_3_month,
                         reply_markup=markup, parse_mode='html')  # Текст сообщения
        ...
        bot.delete_message(chat_id=callback.message.chat.id,
                           message_id=callback.message.id)  # Удаление пердыдущего сообщения
        bot.send_message(chat_id=callback.message.chat.id, text=messages.time_extra_12_month,
                         reply_markup=markup, parse_mode='html')  # Текст сообщения
        ...
        bot.delete_message(chat_id=callback.message.chat.id,
                           message_id=callback.message.id)  # Удаление пердыдущего сообщения
        bot.send_message(chat_id=callback.message.chat.id, text=messages.time_essen_1_month,
                         reply_markup=markup, parse_mode='html')  # Текст сообщения
        ...
        bot.delete_message(chat_id=callback.message.chat.id,
                           message_id=callback.message.id)  # Удаление пердыдущего сообщения
        bot.send_message(chat_id=callback.message.chat.id, text=messages.time_essen_3_month,
                         reply_markup=markup, parse_mode='html')  # Текст сообщения
        ...
        bot.delete_message(chat_id=callback.message.chat.id,
                           message_id=callback.message.id)  # Удаление пердыдущего сообщения
        bot.send_message(chat_id=callback.message.chat.id, text=messages.time_essen_12_month,
                         reply_markup=markup, parse_mode='html')  # Текст сообщения
        ...
        bot.delete_message(chat_id=callback.message.chat.id,
                           message_id=callback.message.id)  # Удаление пердыдущего сообщения
        bot.send_message(chat_id=callback.message.chat.id, text=messages.time_eplay_1_month,
                         reply_markup=markup, parse_mode='html')  # Текст сообщения
        ...
        bot.delete_message(chat_id=callback.message.chat.id,
                           message_id=callback.message.id)  # Удаление пердыдущего сообщения
        bot.send_message(chat_id=callback.message.chat.id, text=messages.time_eplay_12_month,
                         reply_markup=markup, parse_mode='html')  # Текст сообщения
        ...
        bot.delete_message(chat_id=callback.message.chat.id,
                           message_id=callback.message.id)  # Удаление пердыдущего сообщения
        bot.send_message(chat_id=callback.message.chat.id, text=messages.start_message,
                         reply_markup=markup, parse_mode='html')  # Текст сообщения
